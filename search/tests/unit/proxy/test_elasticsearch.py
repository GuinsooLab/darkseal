...
from darkseal_search.models.dashboard import Dashboard
...
from darkseal_search.models.user import User
from darkseal_search.proxy import get_proxy_client
from darkseal_search.proxy.elasticsearch import ElasticsearchProxy
...
class TestElasticsearchProxy(unittest.TestCase):
    ...
    @patch('darkseal_search.proxy.elasticsearch.Elasticsearch', autospec=True)
    ...
    @patch('darkseal_search.proxy._proxy_client', None)
    ...
    @patch('darkseal_search.proxy.elasticsearch.ElasticsearchProxy._search_helper')
