...
PROXY_CLIENTS = {
    'ELASTICSEARCH': 'darkseal_search.proxy.elasticsearch.ElasticsearchProxy',
    'ELASTICSEARCH_V2': 'darkseal_search.proxy.es_search_proxy.ElasticsearchProxy'
}
...
class Config:
    ...
    # LOG_CONFIG_FILE = 'darkseal_search/logging.conf'
