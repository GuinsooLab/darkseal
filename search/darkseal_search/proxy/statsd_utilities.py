...
def timer_with_counter(f: Callable) -> Any:
    ...
    e.g: decorating function neo4j_proxy,get_table will emit:
      - darkseal_medata.proxy.neo4j_proxy.get_table.success.count
      - darkseal_medata.proxy.neo4j_proxy.get_table.fail.count
      - darkseal_medata.proxy.neo4j_proxy.get_table.timer
