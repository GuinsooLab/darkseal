...
from darkseal_common.models.api import health_check
from darkseal_common.models.dashboard import DashboardSummary
from darkseal_common.models.feature import Feature, FeatureWatermark
from darkseal_common.models.generation_code import GenerationCode
from darkseal_common.models.lineage import Lineage, LineageItem
from darkseal_common.models.popular_table import PopularTable
from darkseal_common.models.table import (Application, Badge, Column,
...
class Neo4jProxy(BaseProxy):
    ...
    def _build_user_from_record(record: dict, manager_name: Optional[str] = None) -> UserEntity:
        """
        Builds user record from Cypher query result. Other than the one defined in darkseal_common.models.user.User,
