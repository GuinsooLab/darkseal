...
from darkseal_common.models.table import (Application, Badge, Column,
                                          ...
                                          Tag, User, Watermark)
from darkseal_common.models.user import User as UserModel
from neo4j import GraphDatabase

from darkseal_medata import create_app
from darkseal_medata.entity.dashboard_detail import DashboardDetail
from darkseal_medata.entity.dashboard_query import DashboardQuery
from darkseal_medata.entity.tag_detail import TagDetail
from darkseal_medata.exception import NotFoundException
from darkseal_medata.proxy.neo4j_proxy import Neo4jProxy
...
class TestNeo4jProxy(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.app = create_app(config_module_class='darkseal_medata.config.LocalConfig')
