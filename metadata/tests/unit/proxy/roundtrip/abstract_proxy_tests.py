...
from darkseal_common.models.table import ProgrammaticDescription, Table
from darkseal_common.tests.fixtures import Fixtures

from darkseal_medata.entity.tag_detail import TagDetail
from darkseal_medata.proxy.shared import checkNotNone
...
class AbstractProxyTest(ABC, Generic[T], unittest.TestCase):
    ...
    def test_rt_table(self) -> None:
        """
        it'd be nice to check that the result could be deserialized as a client of the darkseal_medata would
        """
