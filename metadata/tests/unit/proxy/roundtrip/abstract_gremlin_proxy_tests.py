...
from darkseal_medata.proxy.gremlin_proxy import (_V, AbstractGremlinProxy,
                                                 FromResultSet,
                                                 _append_traversal,
...
class AbstractGremlinProxyTest(abstract_proxy_test_class(), unittest.TestCase):  # type: ignore
    ...
    def setUp(self) -> None:
        self.app: Flask = create_app(config_module_class='darkseal_medata.config.LocalConfig')
