...
from darkseal_common.models.table import (Badge, Column,
                                          ProgrammaticDescription, Reader,
                                          ResourceReport, Stat, Table, User)
from darkseal_common.utils.atlas import AtlasCommonParams, AtlasCommonTypes
...
class TestAtlasProxy(unittest.TestCase, Data):
    def setUp(self) -> None:
        ...
        with patch('darkseal_medata.proxy.atlas_proxy.AtlasClient'):
            # Importing here to make app context work before
            # importing `current_app` indirectly using the AtlasProxy
            from darkseal_medata.proxy.atlas_proxy import AtlasProxy
