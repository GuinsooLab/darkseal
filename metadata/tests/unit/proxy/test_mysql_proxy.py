...
from darkseal_medata.proxy import mysql_proxy
from darkseal_medata.proxy.mysql_proxy import MySQLProxy
...
class TestMySQLProxy(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.app = create_app(config_module_class='darkseal_medata.config.MySQLConfig')
