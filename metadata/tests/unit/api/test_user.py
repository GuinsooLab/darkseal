...
class UserDetailAPITest(unittest.TestCase):
    @mock.patch('darkseal_medata.api.user.get_proxy_client')
    ...
    def test_put(self) -> None:
        ...
        with mock.patch("darkseal_medata.api.user.request", m):
            # Test user creation
    ...
    def test_put_no_inputs(self) -> None:
        ...
        m2 = MagicMock()
        m2.data = {}
        with mock.patch("darkseal_medata.api.user.request", m2):
