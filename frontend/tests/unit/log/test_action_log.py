...
from darkseal_application.log import action_log, action_log_callback
from darkseal_application.log.action_log import action_logging
from darkseal_application.log.action_log import get_epoch_millisec

# from mock import patch
# from flask import current_app

app = flask.Flask(__name__)
app.config.from_object('darkseal_application.config.LocalConfig')
