...
import flask
import unittest
from darkseal_application.proxy.issue_tracker_clients.issue_exceptions import IssueConfigurationException
from darkseal_application.proxy.issue_tracker_clients.jira_client import (JiraClient,
                                                                          SEARCH_STUB_ALL_ISSUES,
                                                                          SEARCH_STUB_OPEN_ISSUES)
from darkseal_application.models.data_issue import DataIssue, Priority
from darkseal_common.models.user import User
from jira import JIRAError
from types import SimpleNamespace
from typing import Dict

app = flask.Flask(__name__)
app.config.from_object('darkseal_application.config.TestConfig')
...
class JiraClientTest(unittest.TestCase):
    ...
    @unittest.mock.patch('darkseal_application.proxy.issue_tracker_clients.jira_client.JIRA')
    ...
    @unittest.mock.patch('darkseal_application.proxy.issue_tracker_clients.jira_client.JIRA')
    @unittest.mock.patch('darkseal_application.proxy.issue_tracker_clients.jira_client.'
    ...
    @unittest.mock.patch('darkseal_application.proxy.issue_tracker_clients.'
    ...
    @unittest.mock.patch('darkseal_application.proxy.issue_tracker_clients.jira_client.JIRA')
    @unittest.mock.patch('darkseal_application.proxy.issue_tracker_clients.jira_client.urllib.parse.quote')
