...
from darkseal_application.proxy.issue_tracker_clients.asana_client import AsanaClient
...
class AsanaClientTest(unittest.TestCase):
    ...
    @unittest.mock.patch('darkseal_application.proxy.issue_tracker_clients.asana_client.asana.Client')
