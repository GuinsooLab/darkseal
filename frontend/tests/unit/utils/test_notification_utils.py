...
from darkseal_application.api.exceptions import MailClientNotImplemented
from darkseal_application.api.utils.notification_utils import get_mail_client, \
    get_notification_html, get_notification_subject, send_notification, NotificationType
from darkseal_application.base.base_mail_client import BaseMailClient

local_app = create_app('darkseal_application.config.TestConfig', 'tests/templates')
local_no_notification_app = create_app('darkseal_application.config.TestNotificationsDisabledConfig', 'tests/templates')
...
class NotificationUtilsTest(unittest.TestCase):
    ...
    @unittest.mock.patch('darkseal_application.api.utils.notification_utils.get_notification_html')
    @unittest.mock.patch('darkseal_application.api.utils.notification_utils.get_notification_subject')
    @unittest.mock.patch('darkseal_application.api.utils.notification_utils.get_mail_client')
