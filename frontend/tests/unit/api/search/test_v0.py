...
from darkseal_application.api.search.v0 import SEARCH_DASHBOARD_ENDPOINT, SEARCH_DASHBOARD_FILTER_ENDPOINT, \
...
class SearchTable(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.darkseal_search_url = local_app.config['SEARCHSERVICE_BASE'] + SEARCH_TABLE_ENDPOINT
        self.darkseal_search_filter_url = local_app.config['SEARCHSERVICE_BASE'] + SEARCH_TABLE_FILTER_ENDPOINT
    ...
    @responses.activate
    @patch('darkseal_application.api.search.v0.transform_filters')
    def test_calls_transform_filters(self, transform_filter_mock: Mock) -> None:
        ...
        responses.add(responses.POST,
                      self.darkseal_search_filter_url,
    ...
    @responses.activate
    @patch('darkseal_application.api.search.v0.transform_filters')
    @patch('darkseal_application.api.search.v0._search_table')
    ...
    @responses.activate
    @patch('darkseal_application.api.search.v0.transform_filters')
    @patch('darkseal_application.api.search.v0.has_filters')
    @patch('darkseal_application.api.search.v0.generate_query_json')
    ...
    def test_does_not_calls_generate_query_json(self, mock_generate_query_json: Mock, has_filters_mock: Mock) -> None:
        ...
        test_term = 'hello'
        test_index = 1
        responses.add(responses.GET, self.darkseal_search_url, json=self.mock_table_results, status=HTTPStatus.OK)
    ...
    def test_request_fail(self) -> None:
        ...
        test_term = 'hello'
        test_index = 1
        responses.add(responses.POST, self.darkseal_search_filter_url, json={}, status=HTTPStatus.BAD_REQUEST)
...
class SearchDashboard(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.darkseal_search_url = local_app.config['SEARCHSERVICE_BASE'] + SEARCH_DASHBOARD_ENDPOINT
        self.darkseal_search_filter_url = local_app.config['SEARCHSERVICE_BASE'] + SEARCH_DASHBOARD_FILTER_ENDPOINT
    ...
    @responses.activate
    @patch('darkseal_application.api.search.v0._search_dashboard')
    ...
    def test_does_not_calls_generate_query_json(self, mock_generate_query_json: Mock, has_filters_mock: Mock) -> None:
        ...
        test_term = 'hello'
        test_index = 1
        responses.add(responses.GET, self.darkseal_search_url, json=self.mock_results, status=HTTPStatus.OK)
        has_filters_mock.return_value = False
