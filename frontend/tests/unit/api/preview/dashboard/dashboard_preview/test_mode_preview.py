...
from darkseal_application.api.preview.dashboard.dashboard_preview.mode_preview import ModePreview, DEFAULT_REPORT_URL_TEMPLATE
from darkseal_application.api.utils import request_utils
...
class TestModePreview(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.app = create_app(config_module_class='darkseal_application.config.LocalConfig')
    ...
    def test_authorization(self) -> None:
        ...
        with patch('darkseal_application.api.preview.dashboard.dashboard_preview.mode_preview.request_metadata') as mock_request_metadata:
