...
PACKAGE_DIR = os.path.join(BASE_DIR, 'darkseal_application', 'static')
...
setup(
    name='darkseal-application',
    version=__version__,
    description='Web UI for Darkseal',
    ...
    entry_points="""
        ...
        logging_action_log=darkseal_application.log.action_log_callback:logging_action_log
    """,
    classifiers=[
