...
from darkseal_application.log.action_log_model import ActionLogParams
...
def register_pre_exec_callback(action_log_callback: Callable) -> None:
    ...
    darkseal_application.log.action_log_model.ActionLogParams
...
def on_post_execution(action_log_params: ActionLogParams) -> None:
    ...
    darkseal_application.log.action_log_model.ActionLogParams. Note that any exception from callback will be logged
