...
from darkseal_application.base.base_preview_client import BasePreviewClient
from darkseal_application.models.preview_data import ColumnItem, PreviewData, PreviewDataSchema
...
class BaseRedashPreviewClient(BasePreviewClient):
    ...
    def get_preview_data(self, params: Dict, optionalHeaders: Dict = None) -> FlaskResponse:
        ...
        match darkseal_application.models.preview_data.PreviewDataSchema
        """
