...
from darkseal_application.api.utils.metadata_utils import marshall_dashboard_partial
from darkseal_application.api.utils.request_utils import get_query_param, request_search
from darkseal_application.api.utils.search_utils import generate_query_json, has_filters, \
...
def _search_table(*, search_term: str, page_index: int, filters: Dict, search_type: str) -> Dict[str, Any]:
    ...
    https://github.com/lyft/amundsensearchlibrary/blob/master/darkseal_search/api/table.py
...
def _search_user(*, search_term: str, page_index: int, search_type: str) -> Dict[str, Any]:
    ...
    Call the search service endpoint and return matching results
    Search service logic defined here:
    https://github.com/lyft/amundsensearchlibrary/blob/master/darkseal_search/api/user.py
...
def _search_dashboard(*, search_term: str, page_index: int, filters: Dict, search_type: str) -> Dict[str, Any]:
    ...
    Call the search service endpoint and return matching results
    Search service logic defined here:
    https://github.com/lyft/amundsensearchlibrary/blob/master/darkseal_search/api/dashboard.py
