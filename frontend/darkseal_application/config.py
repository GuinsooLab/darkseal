...
from darkseal_application.models.user import User

from flask import Flask  # noqa: F401

from darkseal_application.tests.test_utils import get_test_user
...
class Config:
    ...
    # LOG_CONFIG_FILE = 'darkseal_application/logging.conf'
