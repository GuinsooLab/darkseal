...
import IconFolderApp from '../assets/svg/ic-folder-app.svg';
...
import IconContainerGreyApp from '../assets/svg/ic-object-store-white.svg';
...
import IconTestSuiteGreyApp from '../assets/svg/icon-test-suite-white.svg';
...
export const Icons = {
  ...
  TEST_SUITE_GREY_APP: 'icon-test-suite-white',
  ...
  DRAG: 'drag',
  CONTAINER: 'container',
  CONTAINER_GREY_APP: 'container-gray-app',
...
const SVGIcons: FunctionComponent<Props> = ({ icon, ...props }: Props) => {
  ...
  switch (icon) {
    ...
    case Icons.FOLDER:
      ...
      break;
    case Icons.FOLDER_GREY_APP:
      IconComponent = IconFolderApp;
    ...
    case Icons.TEST_SUITE_GREY_APP:
      IconComponent = IconTestSuiteGreyApp;
    ...
    case Icons.CONTAINER_GREY_APP:
      IconComponent = IconContainerGreyApp;
